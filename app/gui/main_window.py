...
from app.gui.components.menu_panel import MenuPanel
from app.gui.components.order_panel import OrderPanel
from app.gui.components.payment_panel import PaymentPanel
from app.utils.menu_loader import load_menu  # Suppression de MenuLoader inutile
import datetime
import socket
...
class MainWindow:
    ...
    def show_reports(self):
        ...
        from app.gui.components.report_panel import ReportPanel  # Chemin absolu
        report_window = ReportPanel(self.root, self.order_service)
        report_window.grab_set()  # Rend la fenêtre modale
